...
❓ Чтобы получить дополнительную информацию, отправьте команду: /help 💡
...
📌 Узнать подробнее о моделях можно, отправив команду: /info 💬""")
    ...
    \- 🛑 **Защита от падения, аварийная остановка\.**  
    ...
    **Модель: ЭП40003**  
    ...
    2️⃣ **Блокирующий механизм при обрыве троса**  
       - 🔹 Площадка мгновенно **фиксируется**, исключая падение.  
    ...
    **Модель: ЭП60003**  
    ...
    - 🔗 **Блокирующий механизм при обрыве троса** – площадка мгновенно фиксируется  
